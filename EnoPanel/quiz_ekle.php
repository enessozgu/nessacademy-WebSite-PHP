...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ekleme_sorgusu = $conn->prepare("INSERT INTO quiz_sorular (question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES (?, ?, ?, ?, ?, ?)");
...
<div class="card-body">
    ...
    <form class="forms-sample" action="quiz_ekle.php" method="post">
