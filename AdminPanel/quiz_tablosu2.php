                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-dark">
                            ...
                            <tbody>
                            <?php
                          $Kelimeler = $conn->query("SELECT * FROM quiz_sorular2 ORDER BY id ");
                           foreach ($Kelimeler as $Kelime) {
                             ?>
                                <tr>
                                <td style="text-align:center;"><a href="quiz_duzenle2.php?id=<?php echo $Kelime['id'] ?>"><i
                          class="mdi mdi-table-edit"></i></a></td>
                                    ...
                                    <td><a href="quiz_sil2.php?id= <?php echo $Kelime['id'] ?>">
