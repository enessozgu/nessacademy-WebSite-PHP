...
if (isset($_SESSION['kullanici_adi'])) {
    ...
    $tel2 = $_SESSION['kullanici_numara'];
    $adres = $_SESSION['kullanici_adres'];
    ...
    $sql = "SELECT profile_picture FROM prime_uyeler WHERE user_name = '$kullanici_adi'";
